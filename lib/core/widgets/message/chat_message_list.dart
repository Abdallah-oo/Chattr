  ...
  Widget build(BuildContext context) {
    ...
    BlocBuilder<FetchPrivateMessagesCubit, FetchPrivateMessagesState>(
      buildWhen: (prev, curr) {
        ...
        return curr.chatId == chatData.chatId; // ← بناء بس لو الـ chatId مطابق
      },
          ...
          return SliverList(
            delegate: SliverChildBuilderDelegate(
              ...
              (context, index) {
                ...
                return BlocBuilder<SelectMessagesCubit, SelectMessagesState>(
                  buildWhen: (prev, curr) {
                    ...
                    return context.read<SelectMessagesCubit>().isSelected(
                        ...
                        (prev is AddSelectMessages
                            ? context.read<SelectMessagesCubit>().isSelected(
                                msg,
                              )
                            : false);
                  },
